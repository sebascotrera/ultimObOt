...
const {
  ...
  + 'FN:𝚂𝚎𝚋𝚊𝚜𝚝𝚒𝚊𝚗\n' // Nama
  + 'ORG:Mr.Pato-Bot;\n' // Nama bot
  + 'TEL;type=CELL;type=VOICE;waid=04126088735:+1 0412-6088735n' // Nomor bot
  + 'END:VCARD' 
  ...
  *OVO :* _${Ovo}_`,
  ...
  pok = await getBuffer(nimek)
  Lxa.sendMessage(from, pok, image, {
	quoted: mek, caption: `𝙰𝚍𝚘𝚙𝚝.𝙼𝚎-𝚋𝚘𝚝`
  })
  ...
  //--Convert stiker to image
				  case 'toimg':
					  ...
					  exec(`ffmpeg -i ${medimg} ${ran}`, (err) => {
						  ...
						  buffer = fs.readFileSync(ran)
						  Lxa.sendMessage(from, buffer, image, {quoted: mek, caption: '𝐀𝐝𝐨𝐩𝐭 𝐦𝐞-𝐁𝐨𝐭✰'})
						  fs.unlinkSync(ran)
					  })
					  break
